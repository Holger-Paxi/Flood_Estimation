...
def plot_and_export_freq_graphs(
    ...
    arg_max_flow_rate.to_csv(path_or_buf='{}max_flow_rate__{}.csv'.format(arg_results_frequency_dir, arg_label))
    ...
    stats.to_csv(path_or_buf='{}max_flow_rate_stats__{}.csv'.format(arg_results_stats_dir, arg_label))
...
cl_mean.to_csv(path_or_buf='{}max_outflows_mean_based.csv'.format(output_dir))
...
cl_median.to_csv(path_or_buf='{}max_outflows_median_based.csv'.format(output_dir))
